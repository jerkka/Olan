...
namespace Olan.AsyncEx {
    ...
    public sealed class AsyncCountdownEvent {
        ...
        /// <summary>
        /// Attempts to add the specified value to the current count. This method returns <c>false</c> if the count is already at zero or if the new count would be greater than <see cref="int.MaxValue"/>.
        /// </summary>
        ...
        /// <summary>
        /// Attempts to add one to the current count. This method returns <c>false</c> if the count is already at zero or if the new count would be greater than <see cref="int.MaxValue"/>.
        /// </summary>
        ...
        private sealed class DebugView {
            ...
            public int CurrentCount => _ce.CurrentCount;
