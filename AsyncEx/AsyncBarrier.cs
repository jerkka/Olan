...
namespace Olan.AsyncEx {
    ...
    public sealed class AsyncBarrier {
        ...
        /// </summary>
        public int Id => IdManager<AsyncBarrier>.GetId(ref _id);
        ...
        public Task SignalAndWaitAsync(int count) {
            var ret = SignalAsync(count, false);
            if (ret == null) {
        ...
        public Task RemoveParticipantsAndWaitAsync(int count) {
            var ret = SignalAsync(count, true);
            if (ret == null) {
        ...
        private sealed class DebugView {
            ...
            public int Id => _barrier.Id;

            public long CurrentPhaseNumber => _barrier._phase;

            public int RemainingParticipants => _barrier._count;

            public int ParticipantCount => _barrier._participants;

            public object PostPhaseAction => (_barrier._asyncPostPhaseAction == null) ? _barrier._syncPostPhaseAction : (object)_barrier._asyncPostPhaseAction;

            public Task CurrentPhaseTask => _barrier._tcs.Task;
