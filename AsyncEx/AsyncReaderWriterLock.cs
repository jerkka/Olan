...
namespace Olan.AsyncEx {
    ...
    public sealed class AsyncReaderWriterLock {
        ...
        public AsyncReaderWriterLock()
            : this(new DefaultAsyncWaitQueue<IDisposable>(), new DefaultAsyncWaitQueue<IDisposable>(), new DefaultAsyncWaitQueue<UpgradeableReaderKey>(), new DefaultAsyncWaitQueue<IDisposable>()) { }
        ...
        #endregion
        #region Nested type: UpgradeableReaderKey
