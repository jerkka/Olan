...
namespace Olan.Xml.Serialization.Core {
    ...
    public abstract class Property {
        ...
        public override string ToString() {
            ...
            var parent = Parent == null ? "null" : Parent.GetType().Name;
    ...
    public abstract class ReferenceTargetProperty : Property {
        ...
        public override string ToString() {
            ...
            var reference = Reference != null ? Reference.ToString() : "null";
    ...
    public sealed class SimpleProperty : Property {
        ...
        public override string ToString() {
            var text = base.ToString();
            return Value != null ? string.Format("{0}, ({1})", text, Value) : string.Format("{0}, (null)", text);
        }
    ...
    public class ComplexProperty : ReferenceTargetProperty {
        ...
        public override void MakeFlatCopyFrom(ReferenceTargetProperty source) {
            ...
            if (complexProperty == null) {
                throw new InvalidCastException(string.Format("Invalid property type to make a flat copy. Expected {0}, current {1}", typeof (ComplexProperty), source.GetType()));
            }
    ...
    public sealed class CollectionProperty : ComplexProperty {
        ...
        public override void MakeFlatCopyFrom(ReferenceTargetProperty source) {
            ...
            if (collectionSource == null) {
                throw new InvalidCastException(string.Format("Invalid property type to make a flat copy. Expected {0}, current {1}", typeof (CollectionProperty), source.GetType()));
            }
    ...
    public sealed class DictionaryProperty : ComplexProperty {
        ...
        public override void MakeFlatCopyFrom(ReferenceTargetProperty source) {
            ...
            if (dictionarySource == null) {
                throw new InvalidCastException(string.Format("Invalid property type to make a flat copy. Expected {0}, current {1}", typeof (DictionaryProperty), source.GetType()));
            }
    ...
    public sealed class SingleDimensionalArrayProperty : ReferenceTargetProperty {
        ...
        public override void MakeFlatCopyFrom(ReferenceTargetProperty source) {
            ...
            if (arrayProp == null) {
                throw new InvalidCastException(string.Format("Invalid property type to make a flat copy. Expected {0}, current {1}", typeof (SingleDimensionalArrayProperty), source.GetType()));
            }
