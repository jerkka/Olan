    ...
    public abstract class PropertySerializer : IPropertySerializer {
        ...
        protected void SerializeCore(PropertyTypeInfo<Property> property) {
            ...
            if (nullProperty != null) {
                SerializeNullProperty(new PropertyTypeInfo<NullProperty>(nullProperty, property.ExpectedPropertyType, property.ValueType));
                return;
            }
            ...
            if (simpleProperty != null) {
                SerializeSimpleProperty(new PropertyTypeInfo<SimpleProperty>(simpleProperty, property.ExpectedPropertyType, property.ValueType));
                return;
            }
            ...
            if (referenceTarget != null) {
                ...
                if (SerializeReferenceTarget(new PropertyTypeInfo<ReferenceTargetProperty>(referenceTarget, property.ExpectedPropertyType, property.ValueType))) {
                    return;
                }
            }
