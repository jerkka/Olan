...
namespace Olan.Xml.Serialization.Deserializing {
    /// <summary>
    ...
    public sealed class ObjectFactory {
        ...
        private object CreateObjectCore(ReferenceTargetProperty property, object copyToObject = null) {
            ...
            if (complexProperty != null) {
                return CreateObjectFromComplexProperty(complexProperty, copyToObject);
            }
        ...
        private object CreateObjectFromComplexProperty(ComplexProperty property, object copyToObject = null) {
            var obj = copyToObject ?? Tools.CreateInstance(property.Type);
            ...
            if (methodInfo != null) {
                ...
                if (parameters.Length == 1) {
                    foreach (var item in property.Items) {
                        ...
                        methodInfo.Invoke(collection, new[] {
                            value
                        });
                    }
                }
            ...
            if (methodInfo != null) {
                ...
                if (parameters.Length == 2) {
                    foreach (var item in property.Items) {
                        ...
                        methodInfo.Invoke(dictionary, new[] {
                            keyValue, valueValue
                        });
                    }
                }
        ...
        private object CreateObjectFromSingleDimensionalArrayProperty(SingleDimensionalArrayProperty property) {
            ...
            var array = CreateArrayInstance(property.ElementType, new[] {
                itemsCount
            }, new[] {
                property.LowerBound
            });
