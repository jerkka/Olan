...
using Olan.Xml.Serialization.Deserializing;
...
namespace Olan.Xml.Serialization {
    ...
    /// </summary>
    public sealed class SharpSerializer : ISerializationProvider {
        #region Fields
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.Synchronized)]
        public object Deserialize(string filename, object copyToObject = null) {
            using (var stream = new FileStream(filename, FileMode.Open, FileAccess.Read)) {
                return Deserialize(stream, copyToObject);
            }
        }
#endif
        ...
        [MethodImpl(MethodImplOptions.Synchronized)]
#endif
        public object Deserialize(Stream stream, object copyToObject = null) {
            try {
                ...
                return factory.CreateObject(property, copyToObject);
            }
