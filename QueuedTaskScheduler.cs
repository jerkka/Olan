...
namespace Olan {
    ...
    public sealed class QueuedTaskScheduler : TaskScheduler, IDisposable {
        ...
        private readonly bool _awaitWrappedTasks;
        ...
        /// <param name="awaitWrappedTasks"></param>
        public QueuedTaskScheduler(TaskScheduler targetScheduler, int maxConcurrencyLevel, bool awaitWrappedTasks = false) {
            // Validate arguments
        ...
        /// <param name="awaitWrappedTasks"></param>
        public QueuedTaskScheduler(int threadCount, string threadName = "", bool useForegroundThreads = false, ThreadPriority threadPriority = ThreadPriority.Normal, ApartmentState threadApartmentState = ApartmentState.MTA, int threadMaxStackSize = 0, Action threadInit = null, Action threadFinally = null, bool awaitWrappedTasks = false) {
        ...
        private int DebugQueueCount {
            get {
                return _queueGroups.Sum(@group => @group.Value.Count);
            }
        }
